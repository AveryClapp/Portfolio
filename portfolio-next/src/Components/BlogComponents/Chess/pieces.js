const pieceComponents = {
  ...
  P: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <path
        d="M 22.5,11
         C 20,11 18,13 18,15.5
         C 18,17.5 19.5,19 21.5,19
         C 19,20.5 17,23.5 17,27
         C 17,30.5 19.5,33.5 22.5,33.5
         C 25.5,33.5 28,30.5 28,27
         C 28,23.5 26,20.5 23.5,19
         C 25.5,19 27,17.5 27,15.5
         C 27,13 25,11 22.5,11
         z
         M 17,36
         L 28,36
         L 28,38.5
  ...
  k: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      ...
      >
        ...
        />
        <path
          d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 19,16 9.5,13 5.5,19.5 C 2.5,25.5 11.5,29.5 11.5,29.5 L 11.5,37 z"
          fill="#000000"
        />
  ...
  p: (
    <svg viewBox="0 0 45 45" className="w-full h-full">
      <path
        d="M 22.5,9 C 20.5,9 18,10.5 18,12.5 C 18,13.5 18.5,14.5 19,15.5 C 16.5,16.5 14,18.5 14,22.5 C 14,27 17,32 20,34.5 C 20,35.5 20,37 20,38 L 25,38 C 25,37 25,35.5 25,34.5 C 28,32 31,27 31,22.5 C 31,18.5 28.5,16.5 26,15.5 C 26.5,14.5 27,13.5 27,12.5 C 27,10.5 24.5,9 22.5,9 z"
        fill="#000000"
        stroke="#000000"
        strokeWidth="1.5"
        strokeLinecap="round"
