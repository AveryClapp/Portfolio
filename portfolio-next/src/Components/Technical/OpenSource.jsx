...
const OpenSource = () => {
  const openSourceContent = `
    <section id="opensource" class="mb-10">
      <h2 class="mb-4 text-2xl font-display font-bold text-neutral-900 tracking-tight">Open Source Contributions^6[I'm always looking to work on cool projects so if you have any recommendations or advice, let me know!]</h2>
